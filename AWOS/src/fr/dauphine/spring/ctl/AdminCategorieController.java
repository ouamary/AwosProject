...
public class AdminCategorieController {
	...
	public String suppression(@RequestParam(value="checkboxes") String[] checkboxes, @ModelAttribute("adminCategorieForm") AdminForm admin, BindingResult result) throws Exception {

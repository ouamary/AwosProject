		...
		<div class="span10">
			...
			<section id="formElement" class="utopia-widget utopia-form-box section">
			    <div class="utopia-widget-title">
			        <img src="${boAssetsURL}software24.png" class="utopia-widget-icon">
			    ...
			    <div class="row-fluid">
			        <div class="utopia-widget-content">
			            <div class="span6 utopia-form-freeSpace">
			            	<form:form enctype="multipart/form-data" class="form-horizontal" commandName="artiste" action="${boActionURL}artiste" method="POST">
			            		<form:errors path="*" />
			                	<fieldset>
			                		<form:hidden path="id" />
			                		...
			                		<c:choose>
			                			<c:when test="${edit==1}">
			                				<div class="control-group">
					                            ...
					                            <div class="controls">
					                                <c:choose>
														<c:when test="${empty artiste.photo}">
															<img src="http://placehold.it/150/f1f1f1/6d6d6d&text=++++:)" />													
														</c:when>
														<c:otherwise>
															<img src="${boActionURL}photo/artiste/${artiste.getId()}">
														</c:otherwise>
													</c:choose>
				                           		</div>
							                </div>
			                        ...
			                        <div class="row-fluid">
			                        	<div class="span4 offset7">
											...
											<a class="btn btn-danger" href="${boActionURL}admin/artiste"> <i

				...
				<div id="footer-nav">
					<ul id="menu-footer-navigation" class="menu">
						<li id="menu-item-57" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-57">
							<a href="http://demo.themesoldier.com/impulse/cart/">Panier</a>
						</li>
						<li id="menu-item-56" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-56">
							<a href="http://demo.themesoldier.com/impulse/checkout/">Checkout</a>
						</li>
						<li id="menu-item-54" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-54">
							<a href="http://demo.themesoldier.com/impulse/my-account/">My Account</a>
						</li>
						<li id="menu-item-55" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-55">
							<a href="http://demo.themesoldier.com/impulse/order-tracking/">Track your order</a>
						</li>
					</ul>
				</div>
			</div>

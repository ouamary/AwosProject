...
<html dir="ltr" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	    ...
	    <c:set var="foURL" value="/AwosProject/fo/" scope="application"/>
	    <c:set var="foAssetsURL" value="${foURL}assets/" scope="application"/>
	    <c:set var="foActionURL" value="${foURL}/action/" scope="application"/>

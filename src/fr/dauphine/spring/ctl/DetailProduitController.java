...
public class DetailProduitController {
	...
	// TODO : implémenter la validation lors de l'ajout d'un produit
	private ProduitValidator produitValidator = new ProduitValidator();
	...
	public ProduitValidator getProduitValidator() {
		return produitValidator;
	}

	public void setProduitValidator(ProduitValidator produitValidator) {
